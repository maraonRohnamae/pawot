		...
		<div class="card card-outline card-primary">
			<div class="card-header">
				...
				<div class="card-tools">
					<a class="btn btn-flat btn-primary btn-sm" type="button" href="<?php echo base_url ?>customer/?page=ticket&view=create_ticket"><span class="fa fa-plus"></span> New Ticket</a>
				</div>
			</div>
			<div class="card-body">
				<div class="container-fluid">
